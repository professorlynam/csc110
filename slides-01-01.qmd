...
-   Office hours: Monday & Wednesday 12:50pm - 1:50pm
...
-   Last day for students to add themselves to a course using UAccess is Sept 1
-   Last day for students to drop without a grade of W (withdraw) is Sept 7
...
-   Using generative AI (for example, ChatGPT) to write or debug code for you
...
-   Readings, videos, exercises, slides, assignment instructions will be available on the course website
...
-   TAs do not debug for you (you wouldn't learn to debug yourself if you are always asking other people to do it for you)
