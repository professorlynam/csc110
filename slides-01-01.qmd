...
-   Hudson Lynam (please call me Professor Lynam or Dr. Lynam)
...
<img src="down_arrow.png" width="50" align="center"/>
...
-   Install Python and an IDE/editor (IDLE, which comes packaged with the Python installation, is recommended)
-   Do the readings, come to class, come to discussion periods, come to office hours, do the assignments yourself 
...
-   Short Projects (to be completed in the discussion period) (10%)

-   Projects (10%)

-   Weekly Quizzes on Wednesday (on paper) (20%)

-   Midterms and Final Exam (on paper) (45%)

-   Class Attendance/Participation (10%)

## Exams and Quizzes

Exams (and quizzes) are on paper. Why?
...
-   Using generative AI to write or debug code for you
-   Copying a solution from the internet
-   Sharing code is cheating

## Why do the work yourself?

Common cheating motivations: fear of failure, "time-saving"

-   Very easy to spot cheating (especially AI code)
-   You're cheating yourself out of learning this new skill (programming)
-   Won't work on the many in-person quizzes, or the exams (huge part of grade!)
-   Setting yourself up for failure on later courses, let alone getting a job that requires programming skills


## Materials

-   Readings, exercises, slides, assignment instructions will be available on the course website
...
Once you read your error messages, tried different things, read the Python documentation, and have the line-by-line explanation of what you are trying to do, then ask for help.
...
👎  start late, ask vague questions, ask TA to debug or write code for you

-   TAs help answer clarification questions 

-   TAs do not debug for you (you won't learn to debug yourself if you're always asking other people to do it for you)

## Treat TAs with respect

Be professional and respectful to TAs

-   TAs are a fantastic resource! However, the responsibility of doing well in this class is ultimately yours, not theirs
-   Keep in mind they're students too, with responsibilities outside of TAing. Be polite and respectful of their time, just as you'd like your peers to treat you!


## How to get help?

-   Come to office hours! Either mine or a TA's
-   Join Piazza 
...
-   But if you put in the work, you can expect to succeed!
-   And when you need it, you have the support of the TAs and myself!
