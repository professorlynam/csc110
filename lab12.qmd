...
After you have read in the file and constructed this list, you can use it to determine your word bank, which words you will need to look for within the puzzle.
...
Gradescope will call the following functions `read_words(filename)`, `read_puzzle(filename)`, and `simple_search(puzzle, words_to_search)`.
