...
The final exam date, time and room is: Dec 11th, 3:30pm-5:30pm, room: TBA

You must keep this time available. Do not schedule any flights, travel plans, or other conflicts with these exams.

All assignments that are submitted on Gradescope are due at 9pm (Typically Wednesdays for programming problems, short projects and Fridays for programming projects).
...
-   [Short Project 12](labs/lab12.html) -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 11") %>% pull(formatted_date)` at 9pm
