...
* Midterm 1, covering modules 1 through 6, on February 25th, please bring photo ID
* Go over readings, class slides, code you've written for Short/Long Projects, Programming Problems, Practice Midterm
* The TAs will be hosting an exam review the 23rd, from 5:30pm-7:30pm, in GS 906
...
Let's do a loop table! The column headers for your table should be index <= 5, total, and index.
```{python}
#| eval: true
#| echo: true
total = 0
