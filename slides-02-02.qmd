...
# if a .py file is imported to a a running program, it's __name__ variable is set to the name of the .py file (or module). so if you import extra_functions.py into main_program.py, the __name__ variable inside extra_fuctions.py will be "extra_functions"
```
