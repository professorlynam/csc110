...
**Due date: the date of the final exam at 9pm**
...
2.  It takes one argument: a `file_name` with a string meant to represent the file to strip data from (in our case "Pokemon.csv")
...
Name the program `pokemon_analysis.py`. Test the program yourself, possibly printing out a few of the stored lists to make sure the data has been imported correctly.
...
2.  It takes two arguments: 'data' as the list of all our imported data, and a `name` with a string meant to represent the name of the Pokemon.
...
3. A summary of what you feel you've learned about data analysis and/or programming by completing this project.
