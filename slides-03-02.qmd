...
-   Our first lab will be hosted next Monday and Tuesday.

-   Double-check to make sure you've signed up for the lab time you want!

-   Programming Problem 1 is due tonight at 9pm (I'd recommend turning in PP2 as well)

-   Project 1 is now available for submissions on Gradescope (due Sept 12th), start early!
...
-   What if we wanted to print out a hundred different guitars?

-   What if we wanted to make 50 different varieties of guitars (or add new heads/bodies/necks)

-   What if you're collaborating with Prof Lynam, and he accidentally types something into one of the guitar string literals?
